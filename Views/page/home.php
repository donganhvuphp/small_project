                      ...
                      <div class="trending-tittle">
                          ...
                          <div class="trending-animated">
                              <ul id="js-news" class="js-hidden">
                                  <li class="news-item">Đừng sống một năm đến 75 lần và gọi đó là cuộc đời
                                  </li>
                                  <li class="news-item">Đừng lựa chọn an nhàn khi bản thân còn có thể chịu được khổ</li>
                                  <li class="news-item">Thay đổi suy nghĩ để làm giàu.</li>
                                  <li class="news-item">Sự trưởng thành không được đánh giá bởi tuổi tác.Vì nó là sự trải nghiệm</li>
                                  <li class="news-item">Thay đổi thói quen , đánh thức sự giàu có.</li>
                              </ul>
                          </div>
              ...
              <div class="row">
                  <div class="col-12">
                      <div class="weekly-news-active dot-style d-flex dot-style">
                          <?php
                            foreach ($selectTopAticle as $top) {
                            ?>
                             <div class="weekly-single">
                              <div class="weekly-img">
                                  <img src="assets/img/avatar_article/<?=$top['avatar']?>" width="370" height="432" alt="">
                              </div>
                              <div class="weekly-caption">
                                  <span class="color1"><?=$top['cate']?></span> <span><?=$top['view']?> lượt xem</span>
                                  <h4><a href="index.php?page=article&method=article_detail&id=<?=$top['id']?>"><?=$top['title']?></a></h4>
                              </div>
                          </div>
                          <?php
                            }
                            ...
                            ?>
                              <div class="weekly2-single">
                                  <div class="weekly2-img">
                                      <img src="assets/img/avatar_article/<?= $top['avatar'] ?>" width="270" height="175" alt="">
                                  </div>
                                  <div class="weekly2-caption">
                                      <span class="color1"><?= $top['cate'] ?></span>
                                      <p><?= $top['view'] ?> lượt xem</p>
                                      <h4><a href="index.php?page=article&method=article_detail&id=<?=$top['id']?>"><?= $top['title'] ?></a></h4>
                                  </div>
                              </div>
                          <?php
